...
function () {
  function Grid(configuration) {
    this.apples = [new _Cell.Cell(Math.floor(Math.random() * 80), Math.floor(Math.random() * 40)), new _Cell.Cell(Math.floor(Math.random() * 80), Math.floor(Math.random() * 40)), new _Cell.Cell(Math.floor(Math.random() * 80), Math.floor(Math.random() * 40)), new _Cell.Cell(Math.floor(Math.random() * 80), Math.floor(Math.random() * 40)), new _Cell.Cell(Math.floor(Math.random() * 80), Math.floor(Math.random() * 40))];
...
function () {
  ...
  Snake.prototype.setDirection = function (direction) {
    if (this.direction === 'Right' && direction === 'Left' || this.direction === 'Left' && direction === 'Right' || this.direction === 'Down' && direction === 'Up' || this.direction === 'Up' && direction === 'Down') {
      return;
    }
